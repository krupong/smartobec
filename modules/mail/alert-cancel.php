...
if($row_alert["count"]>0){
	...
	$alertmessage = "<li><a href='?".$link."'><span class='glyphicon glyphicon-envelope' aria-hidden='true'></span>&nbsp;:&nbsp;".$message." <span class='badge progress-bar-danger'>".$row_alert["count"]."</span></a></li>";
}
