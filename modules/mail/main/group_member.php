...
echo "<table width='75%' CELLSPACING=1 CELLPADDING=2>";
	...
	echo "</tr>";
$sql = "select * from person_main left join person_position on person_main.position_code=person_position.position_code where person_main.status='0' order by person_main.department,person_main.position_code,person_main.person_order ";
