...
echo "<table width='65%' CELLSPACING=1 CELLPADDING=2>";
	...
	echo "</tr>";
$sql = "select * from mail_group_member left join person_main on mail_group_member.person_id=person_main.person_id  where mail_group_member.grp_id='$_POST[grp_id]' order by person_main.department,person_main.position_code,person_main.person_order ";
