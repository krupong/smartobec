...
echo "<br><br><div align='center'><table width='70%'><tr><td>";
...
echo "<tr>";
echo "<td align='right' ><span lang='th'><font color='#0000FF'>เลขที่หนังสือ&nbsp;</font></span></td><td align='left' colspan='2'>&nbsp;<input type='text' name='book_no' size='35' style='background-color: #E7D8EB'></td></tr><tr><td align='right'><font color='#0000FF'>ลงวันที่</font></td>";
...
echo "<tr>";
echo "<td align='right'><span lang='th'><font color='#0000FF'>จาก&nbsp;</font></span></td>";
echo "<td colspan='3' align='left'>&nbsp;<input type='text' name='book_from' size='80'  style='background-color: #E7D8EB'></td>";
echo "</tr>";

echo "<Tr><Td align='right'><span id='group'><font color='#0000FF'>เรียน&nbsp;</font></div>&nbsp;&nbsp;</Td>";
echo "<td align='left'>";
echo "<div id='book_to' align='left'><Select  name='book_to'  id='book_to'  size='1' style='background-color: #FFDDFF'>";
echo  "<option  value = ''>เลือก</option>" ;
$sql_person_position = "select * from person_position  where position_type =1 order by position_code";
$dbquery_person_position = mysqli_query($connect,$sql_person_position);
	While ($result_person_position = mysqli_fetch_array($dbquery_person_position))
   {
		//$department = $result_person_position['department'];
		$person_position_code = $result_person_position['position_code'];
		$person_position_name = $result_person_position['position_name'];
		echo  "<option value = $person_position_code>$person_position_name</option>" ;
	}
echo "</select>";
echo "</td></tr>";

//echo "<tr>";
//echo "<td align='right'><span lang='th'><font color='#0000FF'>เรียน&nbsp;</font></span></td>";
...
echo "<tr>";
echo "<td align='right'><span lang='th'><font color='#0000FF'>ชั้นความเร็ว&nbsp;</font></span></td>";
echo "<td colspan='3' align='left'>&nbsp;<input type='radio' name='level' value='0' checked><font color='#006600'>ปกติ</font><span lang='en-us'><font size='2'>&nbsp;
			</font><input type='radio' name='level' value='1'><font color='#FF0000'>ด่วน</font>&nbsp;&nbsp;<input type='radio' name='level' value='2'><font color='#FF0000'>ด่วนมาก</font>&nbsp;&nbsp;<input type='radio' name='level' value='3'><font color='#FF0000'>ด่วนที่สุด</font></td>";
echo "</tr>";

echo "<tr>";
echo "<td align='right'><span lang='th'><font color='#0000FF'>เรื่อง&nbsp;</font></span></td>";
echo "<td colspan='3' align='left'>&nbsp;<input type='text' name='subject' size='80'  style='background-color: #E7D8EB'></td>";
echo "</tr>";

echo "<tr>";
echo "<td align='right'><span lang='th'><font color='#0000FF'>หน่วยปฏิบัติ&nbsp;</font></span></td>";
echo "<td colspan='3' align='left'>&nbsp;<Select  name='department'  id='department'  size='1' style='background-color: #FFDDFF'>";
echo  "&nbsp;&nbsp;<option  value = ''>เลือก</option>" ;
...
echo "<tr>";
echo "<td align='right'><span lang='th'><font color='#0000FF'>บุคคลปฏิบัติ&nbsp;</font></span></td>";
echo "<td colspan='3' align='left'>&nbsp;<input type='text' name='operation' size='50'  style='background-color: #FFDDFF'></td>";
echo "</tr>";

echo "<tr>";
echo "<td align='right'><span lang='th'><font color='#0000FF'>หมายเหตุ&nbsp;</font></span></td>";
echo "<td colspan='3' align='left'>&nbsp;<input type='text' name='comment' size='50'  style='background-color: #FFDDFF' value='เอกสารกระดาษ'></td>";
echo "</tr>";

echo "<tr>";
echo "<td width='371' align='right' colspan='2'><p align='center'><font color='#800000'>แนบไฟล์(ถ้ามี)</font></td>";
echo "<td width='450' align='center' colspan='1'><p align='center'><font color='#800000'>คำอธิบายไฟล์</font></td>";
//echo "<td width='238' align='center' colspan='1'><p align='center'><font color='#800000'></font></td>";

echo "</tr>";

echo "<tr>";
echo "<td width='94' align='right'><font color='#0000FF'>ไฟล์แนบ 1&nbsp;</font></td>";
...
echo "<tr>";
echo "<td width='94' align='right'><font color='#0000FF'>ไฟล์แนบ 2&nbsp;</font></td>";
...
echo "<tr>";
echo "<td width='94' align='right'><font color='#0000FF'>ไฟล์แนบ 3&nbsp;</font></td>";
...
echo "<tr>";
echo "<td width='94' align='right'><font color='#0000FF'>ไฟล์แนบ 4&nbsp;</font></td>";
...
echo "<tr>";
echo "<td width='94' align='right'><font color='#0000FF'>ไฟล์แนบ 5&nbsp;</font></td>";
...
echo "<tr>";
echo "<td align='center' colspan='4'><FONT COLOR='#CC9900'>เฉพาะไฟล์ doc, docx, pdf, xls, xlsx, gif, jpg, zip, rar เท่านั้น</FONT></td>";
echo "</tr>";
echo "<tr>";
...
$sql = "insert into bookregister_receive(year, register_number, book_no, signdate, book_from, book_to, subject, department, record_type, operation, comment, register_date, ref_id, officer, level) values ('$result_start[year]', '$register_number', '$_POST[book_no]', '$_POST[signdate]', '$_POST[book_from]', '$_POST[book_to]', '$_POST[subject]', '$_POST[department]', '1','$_POST[operation]', '$_POST[comment]', '$day_now', '$ref_id', '$user', '$_POST[level]')";
$dbquery = mysqli_query($connect,$sql);
...
$department_id2 = $_POST[department];
$sub_department_id2 = $_POST[sub_department];
$signdate = $_POST[signdate];

			$sql_book = "insert into book_main (book_type, office, sender, level, secret, book_no, signdate, subject, detail, ref_id, send_date, bookregis_link) values ('2', '$user', '$_SESSION[login_user_id]', '$level', '0', '$book_no', '$signdate','$subject','$detail','$ref_id','$day_now','1')";
			$dbquery = mysqli_query($connect,$sql_book);

			//
			$sql_sendto=	"insert into book_sendto_answer (send_level, ref_id, send_to, answer, answer_time) values ('2', '$ref_id','saraban','1','$day_now')";
			$dbquery = mysqli_query($connect,$sql_sendto);
			//
			$sql_sendto2=	"insert into book_sendto_answer (send_level, ref_id, send_to, school, status, answer, answer_time) values ('2', '$ref_id','$_POST[department]','saraban','1','NULL','')";
			$dbquery = mysqli_query($connect,$sql_sendto2);
		//	}   //if isset


if ($myfile1<>"" ) {
$myfile1name=$ref_id."_1.".$lastname1 ; 
copy ($myfile1, "upload/bookregister/upload_files2/".$myfile1name)  ; 
...
copy ($myfile2, "upload/bookregister/upload_files2/".$myfile2name)  ; 
...
copy ($myfile3, "upload/bookregister/upload_files2/".$myfile3name)  ; 
...
copy ($myfile4, "upload/bookregister/upload_files2/".$myfile4name)  ; 
...
copy ($myfile5, "upload/bookregister/upload_files2/".$myfile5name)  ; 
...
$sql = "select * from  bookregister_receive_filebook where  ref_id='$result_ref[ref_id]' order by id DESC";
$dbquery = mysqli_query($connect,$sql);
...
echo "<td colspan='4' height='23' align='left'><font color='#FFFFFF'>&nbsp;รายละเอียด</font></td>";
echo "</tr>";

echo "<tr>";
echo "<td align='right'><span lang='th'><font color='#0000FF'>เลขทะเบียน&nbsp;</font></span></td>";
echo "<td colspan='3' align='left'>&nbsp;$result_ref[register_number]</td>";
echo "</tr>";

echo "<tr>";
echo "<td align='right'><span lang='th'><font color='#0000FF'>เลขที่หนังสือ&nbsp;</font></span></td><td align='left'>&nbsp;<FONT COLOR=''></FONT><input type='text' name='book_no' size='25' value='$result_ref[book_no]'  style='background-color: #E7D8EB'>&nbsp;&nbsp;ลงวันที่</td>";
echo "<td colspan='2' align='left'>";
...
$dbquery_person_position = mysqli_query($connect,$sql_person_position);
	While ($result_person_position = mysqli_fetch_array($dbquery_person_position))
   {
		...
		$person_position_name = $result_person_position['position_name'];
		//echo  "<option value = $person_position_code>$person_position_name</option>" ;
		if($result_ref['book_to']==$person_position_code){ 
		echo  "<option value = $person_position_code selected>$person_position_name</option>" ;
		}
		else{
		echo  "<option value = $person_position_code>$person_position_name</option>" ;
		}
...
echo "<td colspan='3' align='left'>&nbsp;<input type='radio' name='level' value='0' $check1><font color='#0000'>ปกติ</font>&nbsp;
			<input type='radio'  name='level' value='1' $check2><font color='#FF0000'>ด่วน</font>&nbsp;
			<input type='radio'  name='level' value='2' $check3><font color='#FF0000'>ด่วนมาก</font>&nbsp;
			<input type='radio'  name='level' value='3' $check4><font color='#FF0000'>ด่วนที่สุด</font></td>";
echo "</tr>";
...
echo "<Tr><Td align='right'><span id='group'><font color='#0000FF'>กลุ่มปฏิบัติ&nbsp;</font></div>&nbsp;&nbsp;</Td>";
echo "<td align='left'colspan='3' >";
echo "<div id='department' align='left'>&nbsp;<Select  name='group'  id='group'  size='1' style='background-color: #FFDDFF'>";
echo  "<option  value = ''>เลือก</option>" ;
$sql_department = "select  * from system_department  order by department_order";
$dbquery_department = mysqli_query($connect,$sql_department);
While ($result_department = mysqli_fetch_array($dbquery_department))
   {
		$department = $result_department['department'];
		$department_name = $result_department['department_name'];
		if($result_ref['department']==$department){ 
...
echo "<tr>";
echo "<td width='371' align='right' colspan='2'><p align='center'><font color='#800000'>แนบไฟล์(ถ้ามี)</font></td>";
echo "<td width='238' align='center' colspan='2'><p align='center'><font color='#800000'>คำอธิบายไฟล์</font></td>";
echo "</tr>";
...
echo "<Input Type=Hidden Name='department' Value='$_REQUEST[department]'>";
echo "<tr>";
...
$sql = "update bookregister_receive set book_no='$_POST[book_no]', signdate='$_POST[signdate]', book_from='$_POST[book_from]', book_to='$_POST[book_to]', subject='$_POST[subject]', department='$_POST[group]', operation='$_POST[operation]', comment='$_POST[comment]', level='$_POST[level]' where ms_id='$_POST[id]' ";
$dbquery = mysqli_query($connect,$sql);
...
$sql = "select * from  bookregister_receive_filebook where  ref_id='$_POST[ref_id]' order by id DESC";
$dbquery = mysqli_query($connect,$sql);
while($result_file = mysqli_fetch_array($dbquery)){
$file=$result_file['file_name'];
$file1=explode("_", $file);
...
$path_file="upload/bookregister/upload_files2/".$myfile1name;
...
$path_file="upload/bookregister/upload_files2/".$myfile2name;
	if(file_exists($path_file)){
	unlink($path_file);	
	}
		if($file_exit[2]==1){
...
$path_file="upload/bookregister/upload_files2/".$myfile3name;
	if(file_exists($path_file)){
	unlink($path_file);	
	}
		if($file_exit[3]==1){
...
$path_file="upload/bookregister/upload_files2/".$myfile4name;
	if(file_exists($path_file)){
	unlink($path_file);	
	}
		if($file_exit[4]==1){
...
$path_file="upload/bookregister/upload_files2/".$myfile5name;
	if(file_exists($path_file)){
	unlink($path_file);	
	}
		if($file_exit[5]==1){
...
if($_REQUEST['search_index']==1){
	...
	$sql="select * from bookregister_receive where department='$department_id'"; 
...
$url_link="option=bookregister&task=main/receive&search_index=$_REQUEST[search_index]&field=$_REQUEST[field]&search=$_REQUEST[search]&department=$_REQUEST[department]";  // 2_กำหนดลิงค์ฺ
...
//echo "<table border='0' width='99%' id='table1' style='border-collapse: collapse' cellspacing='2' cellpadding='2' align='center'><tr><td>";
//echo "<table class='table table-bordered' width='100%' style='background-color:rgba(255,255,255,0.9)'>";
echo "<table class='table table-striped table-bordered table-hover table-condensed'>";
...
<table class="table table-striped table-bordered table-hover table-condensed">
				<tr>
					<td align="center">
					<strong>เลขทะเบียนรับ สพฐ.</strong></td>
					<td align="center">
					<strong>ปี</strong></td>
					<td align="center">
					...
					<td align="center">
					<strong>ถึง</strong></td>
					<td align="center">
					<strong>เรื่อง</strong></td>
					<td align="center">
					<strong>สำนัก</strong></td>
					<td align="center">
					<strong>บุคคลปฏิบัติ</strong></td>
					<td align="center">
					<strong>หมายเหตุ</strong></td>
					<td align="center">
					<strong>วันลงทะเบียน</strong></td>
					<td align="center">
					<strong>ราย<br />ละเอียด</strong></td>
					<td align="center">
					<strong>ลบ</strong></td>
					<td align="center">
					<strong>แก้ไข</strong></td>
				</tr>
<?php
if($_REQUEST['search_index']==1){
		if($_REQUEST['department']!=""){
		$sql="select * from bookregister_receive where $_REQUEST[field] like '%$_REQUEST[search]%' and department='$_REQUEST[department]' order by year DESC,register_number  DESC limit $start,$pagelen "; 
		}
		else{
		$sql="select * from bookregister_receive where $_REQUEST[field] like '%$_REQUEST[search]%' order by year DESC,register_number  DESC limit $start,$pagelen "; 
		}
}
else{
$sql="select * from bookregister_receive order by year DESC,register_number DESC limit $start,$pagelen "; 
}
$dbquery = mysqli_query($connect,$sql);
...
//แสดงสอบแหน่ง
	...
	$sql3="select * from person_position  where position_code =$book_to";    //รหัสสำนัก 
	$dbquery3 = mysqli_query($connect,$sql3);
	$ref_result3 = mysqli_fetch_array($dbquery3);
	$position_name = $ref_result3['position_name'];
//
...
?>
			<tr>
					...
					<td align="left"><?php echo $subject;?>&nbsp;<?php echo $file_img;?>&nbsp;</td>
					<td align="left"><?php 
...
onclick="window.open('modules/bookregister/main/bookdetail_receive.php?id=<?php echo $result['ms_id'];?>', 'bookdetail','width=500,height=500,scrollbars')" title="คลิกเพื่อดูรายละเอียด"><span class='glyphicon glyphicon-list-alt' aria-hidden='true'></span></A></td>
<?php
//ตั้งค่าเวลาให้ลบได้					
$now=time();
...
echo "<Td align='center'><a href=?option=bookregister&task=main/receive&index=2&id=$id&page=$_REQUEST[page]><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a></Td>";
}
else{
echo "<td></td>";
}
if(($result['officer']==$user) and ($delete==1)){
echo "<Td align='center'><a href=?option=bookregister&task=main/receive&index=5&id=$id&page=$_REQUEST[page]&department=$_REQUEST[department]><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></a></Td>";
}
else{
echo "<td></td>";
}
...
echo "<tr><td colspan='5'>&nbsp;&nbsp;<FONT COLOR='#009933'><IMG SRC='modules/bookregister/images/file1.gif' WIDTH='16' HEIGHT='16' BORDER='0'>มีไฟล์เอกสาร</FONT>&nbsp;&nbsp;&nbsp;<a href='modules/bookregister/main/export_receive_all.php ' target='_blank'>ส่งออกทั้งหมด Excel ปีปัจจุบัน</a>";
?><form id='form1' name='form1' method='post' action='modules/bookregister/main/export_receive_all_day.php?department=<?php echo $_REQUEST[department] ?>' target='_blank'><td colspan='1'>เลือกวันที่ </td><td colspan='4'><input type='submit' name='button' id='button' value='ส่งออก Excel' /><script>DateInput('date_value', true, 'YYYY-MM-DD')</script><script>DateInput('date_value2', true, 'YYYY-MM-DD')</script></td></form>
<?php
echo "</td><td colspan='8'>";
if($_REQUEST['department']!=""){
echo "ส่งออก[Excel]เฉพาะที่ลงทะเบียนเอกสารกระดาษ<a href='modules/bookregister/main/export_to_excel.php?department=$_REQUEST[department]' target='_blank'>[คลิก]</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ส่งออก[Excel]ทั้งหมด<a href='modules/bookregister/main/export_to_excel2.php?department=$_REQUEST[department]' target='_blank'>[คลิก]</a>";
}
echo "</td></tr>";
echo "</table>";
}  //end index
