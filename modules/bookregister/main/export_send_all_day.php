...
header('Content-Disposition: attachment; filename="send_all.xls"');# ชื่อไฟล์ 
?>
...
$sql="select * from bookregister_send where register_date BETWEEN '$register_date'  and '$register_date2' order by ms_id ";
}
if ($department_id > '' and $sub_department_id == ''){  //สารบรรณสำนัก
$sql="select * from bookregister_send where register_date BETWEEN '$register_date'  and '$register_date2' and department='$department_id' order by ms_id ";
}
if ($department_id == '' and $sub_department_id > ''){  //สารบรรณกลุ่ม
$sql="select * from bookregister_send where register_date BETWEEN '$register_date'  and '$register_date2' and sub_department='$sub_department_id' order by ms_id ";
}
