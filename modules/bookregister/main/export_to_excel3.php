...
header('Content-Disposition: attachment; filename="command_obec.xls"');# ชื่อไฟล์ 
...
//เรียกชื่อสำนัก
	...
	$department_precis = $result_d['department_precis'];
		...
		echo "<Tr><Td align='center'>$register_number</Td><Td align='center'>$year</Td><Td align='left'>เลขที่ $book_no</Td><Td align='left'>$subject</Td><Td align='left'>$signdate</Td><Td align='left'>$comment </Td>";
echo "<Td align='left'>";
echo $result['prename'].$result['name']." ".$result['surname'];
echo "($department_precis)";
echo "</Td>";
