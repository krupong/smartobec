...
echo "<tr align='center'><td><font color='#006666' size='3'><strong>ทะเบียนหนังสือส่ง</strong></font></td></tr>";
echo "</table>";
}

//เช็คการเปิดใช้งานทะเบียน
$sql_start="select * from bookregister_year where year_active='1' and school_code='$_SESSION[user_school]'";
...
//เลขที่หนังสือหน่วยงาน
	$sql="select * from bookregister_office_no where school_code='$_SESSION[user_school]' ";
...
echo "<Center>";
echo "<Font color='#006666' Size=3><B>ลงทะเบียนหนังสือส่ง</Font>";
echo "</Cener>";
echo "<Br>";
...
echo "<td colspan='3' align='left'>&nbsp;<input type='text' name='book_from' size='80' value='$_SESSION[system_school_name]' style='background-color: #E7D8EB'></td>";
echo "</tr>";
...
echo "<tr>";
echo "<td align='right'><span lang='th'><font size='2' color='#0000FF'>การปฏิบัติ&nbsp;</font></span></td>";
...
echo "<INPUT TYPE='button' name='smb' value='ยืนยัน' onclick='location.href=\"?option=bookregister&task=main/send_sch&index=3&id=$_GET[id]&page=$_REQUEST[page]\"'>
		&nbsp;&nbsp;<INPUT TYPE='button' name='back' value='ยกเลิก' onclick='location.href=\"?option=bookregister&task=main/send_sch&page=$_REQUEST[page]\"'";
echo "</td></tr></table>";
}
...
$sql = "delete from bookregister_send_filebook_sch where ref_id='$ref_id'";
$dbquery = mysqli_query($connect,$sql);

$sql = "delete from bookregister_send_sch where ms_id='$_GET[id]'";
$dbquery = mysqli_query($connect,$sql);
}
...
$sql_number="select  max(register_number) as number_max from bookregister_send_sch where school_code='$_SESSION[user_school]' and  year='$result_start[year]'  ";
...
if($_POST['book_no']==1){
$book_number=$ref_result['office_no']."ว".$register_number;
}
else{
$book_number=$ref_result['office_no'].$register_number;
}

$sql = "insert into bookregister_send_sch(school_code, year, register_number, book_no, signdate, book_from, book_to, subject, operation, comment, register_date, ref_id, officer, secret) values ('$_SESSION[user_school]', '$result_start[year]', '$register_number', '$book_number', '$_POST[signdate]', '$_POST[book_from]', '$_POST[book_to]', '$_POST[subject]', '$_POST[operation]', '$_POST[comment]', '$day_now', '$ref_id', '$user', '$_POST[secret]')";
$dbquery = mysqli_query($connect,$sql);
...
$sql = "insert into bookregister_send_filebook_sch(school_code, ref_id, file_name, file_des) values ('$_SESSION[user_school]', '$ref_id','$myfile1name','$dfile1')";
$dbquery = mysqli_query($connect,$sql);
...
$sql = "insert into bookregister_send_filebook_sch(school_code, ref_id, file_name, file_des) values ('$_SESSION[user_school]', '$ref_id','$myfile2name','$dfile2')";
$dbquery = mysqli_query($connect,$sql);
unlink ($myfile2) ;
}
...
$sql = "insert into bookregister_send_filebook_sch(school_code, ref_id, file_name, file_des) values ('$_SESSION[user_school]', '$ref_id','$myfile3name','$dfile3')";
$dbquery = mysqli_query($connect,$sql);
unlink ($myfile3) ;
}
...
$sql = "insert into bookregister_send_filebook_sch(school_code, ref_id, file_name, file_des) values ('$_SESSION[user_school]', '$ref_id','$myfile4name','$dfile4')";
$dbquery = mysqli_query($connect,$sql);
unlink ($myfile4) ;
}
...
$sql = "insert into bookregister_send_filebook_sch(school_code, ref_id, file_name, file_des) values ('$_SESSION[user_school]', '$ref_id','$myfile5name','$dfile5')";
$dbquery = mysqli_query($connect,$sql);
unlink ($myfile5) ;
}
...
$sql = "update bookregister_send_sch set book_no='$_POST[book_no]', signdate='$_POST[signdate]', book_from='$_POST[book_from]', book_to='$_POST[book_to]', subject='$_POST[subject]', operation='$_POST[operation]', comment='$_POST[comment]', secret='$_POST[secret]'  where ms_id='$_POST[id]' ";
$dbquery = mysqli_query($connect,$sql);
...
$sql = "select * from  bookregister_send_filebook_sch where  ref_id='$_POST[ref_id]' order by id";
$dbquery = mysqli_query($connect,$sql);
while($result_file = mysqli_fetch_array($dbquery)){
$file=$result_file['file_name'];
$file1=explode("_", $file);
...
$path_file="upload/bookregister/upload_files2/".$myfile1name;
	...
	unlink($path_file);	
		...
		if($file_exit[1]==1){
		copy ($myfile1, "upload/bookregister/upload_files2/".$myfile1name) ; 
		$sql = "update bookregister_send_filebook_sch set file_name='$myfile1name', file_des='$dfile1' where id='$file_id[1]' "; 
		}
		else{
		copy ($myfile1, "upload/bookregister/upload_files2/".$myfile1name) ; 
		$sql = "insert into bookregister_send_filebook_sch(school_code, ref_id, file_name, file_des) values ('$_SESSION[user_school]', '$_POST[ref_id]','$myfile1name','$dfile1')";
		}
$dbquery = mysqli_query($connect,$sql);
unlink ($myfile1) ;
}
...
$path_file="upload/bookregister/upload_files2/".$myfile2name;
	...
	unlink($path_file);	
		...
		if($file_exit[2]==1){
		copy ($myfile2, "upload/bookregister/upload_files2/".$myfile2name) ; 
		$sql = "update bookregister_send_filebook_sch set file_name='$myfile2name', file_des='$dfile2' where id='$file_id[2]' "; 
		}
		else{
		copy ($myfile2, "upload/bookregister/upload_files2/".$myfile2name) ; 
		$sql = "insert into bookregister_send_filebook_sch(school_code, ref_id, file_name, file_des) values ('$_SESSION[user_school]', '$_POST[ref_id]','$myfile2name','$dfile2')";
		}
$dbquery = mysqli_query($connect,$sql);
unlink ($myfile2) ;
}
...
$path_file="upload/bookregister/upload_files2/".$myfile3name;
	...
	unlink($path_file);	
		...
		if($file_exit[3]==1){
		copy ($myfile3, "upload/bookregister/upload_files2/".$myfile3name) ; 
		$sql = "update bookregister_send_filebook_sch set file_name='$myfile3name', file_des='$dfile3' where id='$file_id[3]' "; 
		}
		else{
		copy ($myfile3, "upload/bookregister/upload_files2/".$myfile3name) ; 
		$sql = "insert into bookregister_send_filebook_sch(school_code, ref_id, file_name, file_des) values ('$_SESSION[user_school]', '$_POST[ref_id]','$myfile3name','$dfile3')";
		}
$dbquery = mysqli_query($connect,$sql);
unlink ($myfile3) ;
}
...
$path_file="upload/bookregister/upload_files2/".$myfile4name;
	...
	unlink($path_file);	
		...
		if($file_exit[4]==1){
		copy ($myfile4, "upload/bookregister/upload_files2/".$myfile4name) ; 
		$sql = "update bookregister_send_filebook_sch set file_name='$myfile4name', file_des='$dfile4' where id='$file_id[4]' "; 
		}
		else{
		copy ($myfile4, "upload/bookregister/upload_files2/".$myfile4name) ; 
		$sql = "insert into bookregister_send_filebook_sch(school_code, ref_id, file_name, file_des) values ('$_SESSION[user_school]', '$_POST[ref_id]','$myfile4name','$dfile4')";
		}
$dbquery = mysqli_query($connect,$sql);
unlink ($myfile4) ;
}
...
$path_file="upload/bookregister/upload_files2/".$myfile5name;
	...
	unlink($path_file);	
		...
		if($file_exit[5]==1){
		copy ($myfile5, "upload/bookregister/upload_files2/".$myfile5name) ; 
		$sql = "update bookregister_send_filebook_sch set file_name='$myfile5name', file_des='$dfile5' where id='$file_id[5]' "; 
		}
		else{
		copy ($myfile5, "upload/bookregister/upload_files2/".$myfile5name) ; 
		$sql = "insert into bookregister_send_filebook_sch(school_code, ref_id, file_name, file_des) values ('$_SESSION[user_school]', '$_POST[ref_id]','$myfile5name','$dfile5')";
		}
$dbquery = mysqli_query($connect,$sql);
unlink ($myfile5) ;
}
...
$sql="select * from bookregister_send_sch where $_REQUEST[field] like '%$_REQUEST[search]%' and school_code='$_SESSION[user_school]' ";
}
else{
$sql="select * from bookregister_send_sch where school_code='$_SESSION[user_school]' "; 
}
$dbquery = mysqli_query($connect,$sql);
$num_rows = mysqli_num_rows($dbquery );

$pagelen=20;  // 1_กำหนดแถวต่อหน้า
$url_link="option=bookregister&task=main/send_sch&search_index=$_REQUEST[search_index]&field=$_REQUEST[field]&search=$_REQUEST[search]";  // 2_กำหนดลิงค์ฺ
...
echo "<INPUT TYPE='button' name='smb' value='ลงทะเบียนหนังสือ' onclick='location.href=\"?option=bookregister&task=main/send_sch&index=1\"'>";
echo "</td>";

?>
	<form method="POST" action="?option=bookregister&task=main/send_sch">
<td align="right">
...
<table border="1" width="99%" id="table2" style="border-collapse: collapse" align="center">
				<tr bgcolor="#99FFFF">
					...
					<td align="center" width="50">
					<font face="Tahoma" size="2">ส่ง</font></td>
				</tr>
<?php
if($_REQUEST['search_index']==1){
$sql="select * from bookregister_send_sch where $_REQUEST[field] like '%$_REQUEST[search]%' and school_code='$_SESSION[user_school]' order by year,register_number  limit $start,$pagelen "; 
}
else{
$sql="select * from bookregister_send_sch where school_code='$_SESSION[user_school]' order by year,register_number limit $start,$pagelen "; 
}
$dbquery = mysqli_query($connect,$sql);
...
// ตรวจสอบไฟล์แนบ
$file = mysqli_query($connect,"SELECT id FROM  bookregister_send_filebook_sch WHERE ref_id='$ref_id' ") ;
...
onclick="window.open('modules/bookregister/main/bookdetail_send_sch.php?id=<?php echo $result['ms_id'];?>', 'bookdetail','width=500,height=500,scrollbars')" title="คลิกเพื่อดูรายละเอียด"><span style="text-decoration: none">คลิก</span></A></td>
<?php
//ตั้งค่าเวลาให้ลบได้					
$now=time();
...
echo "<Td align='center'><a href=?option=bookregister&task=main/send_sch&index=2&id=$id&page=$_REQUEST[page]><img src=images/drop.png border='0' alt='ลบ'></a></Td>";
}
else{
echo "<td></td>";
}
if(($result['officer'])==$user and ($delete==1)){
echo "<Td align='center'><a href=?option=bookregister&task=main/send_sch&index=5&id=$id&page=$_REQUEST[page]><img src=images/edit.png border='0' alt='แก้ไข'></a></Td>";
}
else{
echo "<td></td>";
}
...
echo "<td align='center'><a href=?option=book&task=main/send_sch_2&id=$id&index=1><img src=images/next.gif border='0' alt='ส่งโรงเรียน'></td>";
}
else{
echo "<td></td>";
}
...
echo "<tr><td colspan='14'>&nbsp;&nbsp;<FONT COLOR='#009933'><IMG SRC='modules/book/images/file1.gif' WIDTH='16' HEIGHT='16' BORDER='0'>มีไฟล์เอกสาร</FONT>&nbsp;&nbsp;&nbsp;<a href='modules/bookregister/export_send_sch.php?year_index=$result_start[year]&school=$_SESSION[user_school]' target='_blank'>ส่งออกExcel</a></td></tr>";
echo "</table>";
}  //end index
...
function goto_url(val){
	if(val==0){
		callfrm("?option=bookregister&task=main/send_sch"); 
	}else if(val==1){
	...
	var vdfile5 = document.frm1.dfile5.value;
		...
		callfrm("?option=bookregister&task=main/send_sch&index=4");   //page ประมวลผล
		}
	}
}
...
function goto_url2(val){
	...
	var vdfile5 = document.frm1.dfile5.value;
		...
		callfrm("?option=bookregister&task=main/send_sch&index=6");   //page ประมวลผล
		}
	}
}
