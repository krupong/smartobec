...
$result_start=mysqli_fetch_array($query_start);
		...
		//echo "<div align='center'>ยังไม่ได้กำหนดปีปฏิทินการทำงาน  สพฐ.  กรุณาแจ้งเจ้าหน้าที่ทะเบียน</div>";
		//ปิดการทำงานที่มีอยู่เดิม (ปีเก่า) //////////////////////////
			$sql4 = "update bookregister_year set  year_active='0' where school_code is null";
			$dbquery4 = mysqli_query($connect,$sql4);

		//เพิ่มปีปฏิทินอัตโนมัติกรณีที่ยังไม่มี		/////////////////////////
		$rec_date = date("Y-m-d");
		$this_year1=$rec_date+543;
		//echo "<div align='center'>ยังไม่ได้กำหนดปีปฏิทินการทำงาน กลุ่ม กรุณาแจ้งเจ้าหน้าที่สารบรรณกลุ่ม</div>";
		echo "<div align='center'>ยังไม่ได้กำหนดปีปฏิทินการทำงาน  สพฐ. ระบบได้เพิ่มปีปฏิทินและเปิดใช้งานให้อัตโนมัติแล้ว คือ  <b>ปี พ.ศ. $this_year1</b></div>";		
		$sql5 = "insert into bookregister_year (year, year_active, start_receive_num, start_send_num, start_command_num, start_cer_num, school_code, department, sub_department) values ('$this_year1', '1', '1', '1', '1', '1', '', '', '')";
...
$result_start=mysqli_fetch_array($query_start);
	...
	//	echo "<div align='center'>ยังไม่ได้กำหนดปีปฏิทินการทำงาน สำนัก กรุณาแจ้งเจ้าหน้าที่สารบรรณสำนัก</div>";
		//echo "<div align='center'>ยังไม่ได้กำหนดปีปฏิทินการทำงาน สำนัก กรุณาแจ้งเจ้าหน้าที่สารบรรณสำนัก</div>";
		//ปิดการทำงานที่มีอยู่เดิม (ปีเก่า) //////////////////////////
			$sql6 = "update bookregister_year set  year_active='0' where department = $department";
			$dbquery6 = mysqli_query($connect,$sql6);

			//เพิ่มปีปฏิทินอัตโนมัติกรณีที่ยังไม่มี		/////////////////////////
		$rec_date = date("Y-m-d");
		$this_year1=$rec_date+543;	
		echo "<div align='center'>ยังไม่ได้กำหนดปีปฏิทินการทำงาน สำนัก ระบบได้เพิ่มปีปฏิทินและเปิดใช้งานให้อัตโนมัติแล้ว คือ  <b>ปี พ.ศ. $this_year1</b></div>";		
		$sql7 = "insert into bookregister_year (year, year_active, start_receive_num, start_send_num, start_command_num, start_cer_num, school_code, department, sub_department) values ('$this_year1', '1', '1', '1', '1', '1', '', '$department', '')";
		$dbquery7 = mysqli_query($connect,$sql7);
		//จบเพิ่มปฏิทิน/////////////////////////
...
$result_start=mysqli_fetch_array($query_start);
		...
		//echo "<div align='center'>ยังไม่ได้กำหนดปีปฏิทินการทำงาน กลุ่ม กรุณาแจ้งเจ้าหน้าที่สารบรรณกลุ่ม</div>";
		//ปิดการทำงานที่มีอยู่เดิม (ปีเก่า) //////////////////////////
			$sql8 = "update bookregister_year set  year_active='0' where sub_department = $sub_department";
			$dbquery8 = mysqli_query($connect,$sql8);

			//เพิ่มปีปฏิทินอัตโนมัติกรณีที่ยังไม่มี		/////////////////////////
		$rec_date = date("Y-m-d");
		$this_year1=$rec_date+543;
		//echo "<div align='center'>ยังไม่ได้กำหนดปีปฏิทินการทำงาน กลุ่ม กรุณาแจ้งเจ้าหน้าที่สารบรรณกลุ่ม</div>";
		echo "<div align='center'>ยังไม่ได้กำหนดปีปฏิทินการทำงาน กลุ่ม ระบบได้เพิ่มปีปฏิทินและเปิดใช้งานให้อัตโนมัติแล้ว คือ  <b>ปี พ.ศ. $this_year1</b></div>";		
		$sql9 = "insert into bookregister_year (year, year_active, start_receive_num, start_send_num, start_command_num, start_cer_num, school_code, department, sub_department) values ('$this_year1', '1', '1', '1', '1', '1', '', '$department', '$sub_department')";
		$dbquery9 = mysqli_query($connect,$sql9);
		//จบเพิ่มปฏิทิน/////////////////////////
...
echo "</Cener>";
echo "<Br>";
echo "<table border='1' width='750' id='table1' style='border-collapse: collapse' bordercolor='#C0C0C0'>";
...
$ioffice_bookid = $_GET["ioffice_bookid"];
$sqlioffice = "SELECT * FROM ioffice_book WHERE bookid = $ioffice_bookid";
//echo $sqlioffice;
if($resultioffice = mysqli_query($connect,$sqlioffice)){
	$rowioffice = $resultioffice->fetch_assoc();
	$bookheader = $rowioffice["bookheader"];
	$post_subdepartmentid = $rowioffice["post_subdepartmentid"];
	$post_personid = $rowioffice["post_personid"];
	$department_bookid = "บันทึกเสนอสั่งการเลขที่ ".$ioffice_bookid." เลขที่สำนัก ".$rowioffice["department_bookid"];
	$booktypeid = $rowioffice["booktypeid"];
}else{
	$bookheader = "";
	$post_subdepartmentid = "";
	$post_personid = "";
	$department_bookid = "";
	$booktypeid = "1";
}
...
echo "<td colspan='3' align='left'>&nbsp;<input type='radio' name='level' value='0' $checked1><font size='2' color='#006600'>ปกติ</font><span lang='en-us'><font size='2'>&nbsp;
			</font><input type='radio' name='level' value='1' $checked2><font size='2' color='#FF0000'>ด่วน</font>&nbsp;&nbsp;<input type='radio' name='level' value='2' $checked3><font size='2' color='#FF0000'>ด่วนมาก</font>&nbsp;&nbsp;<input type='radio' name='level' value='3' $checked4><font size='2' color='#FF0000'>ด่วนที่สุด</font></td>";
echo "</tr>";

echo "<tr>";
echo "<td align='right'><span lang='th'><font size='2' color='#0000FF'>จาก&nbsp;</font></span></td>";
echo "<td colspan='3' align='left'>&nbsp;<input type='text'  class='textinput' value = 'สำนักงานคณะกรรมการการศึกษาขั้นพื้นฐาน' name='book_from' size='80'  style='background-color: #E7D8EB'></td>";
echo "</tr>";

echo "<tr>";
echo "<td align='right'><span lang='th'><font size='2' color='#0000FF'>ถึง&nbsp;</font></span></td>";
echo "<td colspan='3' align='left'>&nbsp;<input type='text' class='textinput' name='book_to' size='80'  style='background-color: #E7D8EB'></td>";
echo "</tr>";

echo "<tr>";
echo "<td align='right'><span lang='th'><font size='2' color='#0000FF'>เรื่อง&nbsp;</font></span></td>";
echo "<td colspan='3' align='left'>&nbsp;<input type='text' class='textinput' name='subject' size='80'  style='background-color: #E7D8EB' value='".$bookheader."'></td>";
echo "</tr>";

echo "<tr>";
echo "<td align='right'><span lang='th'><font size='2' color='#0000FF'>หน่วยปฏิบัติ&nbsp;</font></span></td>";
echo "<td colspan='3' align='left'>&nbsp;<Select  name='sub_department' class='textinput'  id='sub_department'  size='1' style='background-color: #FFDDFF'>";
...
While ($result_subdepartment = mysqli_fetch_array($dbquery_subdepartment))
   {
		...
		if($sub_department==$post_subdepartmentid){ $selected="selected"; }else{ $selected=""; } 
		echo  "<option value = $result_subdepartment[sub_department] $selected>$result_subdepartment[sub_department_name]</option>" ;
	}
echo "</select>";
...
echo "<td colspan='3' align='left'>&nbsp;<Select class='textinput' name='operation'  id='operation'  size='1' style='background-color: #FFDDFF'>";
echo  "&nbsp;&nbsp;<option  value = ''>เลือก</option>" ;
$sql_person= "select  * from person_main  where department=$department";
...
While ($result_person = mysqli_fetch_array($dbquery_person))
   {
		...
		if($person_id==$post_personid){ $selected="selected"; }else{ $selected=""; } 
...
echo "<td colspan='3' align='left'>&nbsp;<input type='text' class='textinput' name='comment' size='50'  style='background-color: #FFDDFF' value='$department_bookid'></td>";
echo "</tr>";
...
echo "<td width='274' align='left'>&nbsp;<input type='file' name='myfile1' class='textinput' size='26' style='background-color: #FFDDFF'></td>";
echo "<td width='238' align='center' colspan='2'><input type='text' class='textinput' name='dfile1' size='31' style='background-color: #BBD1FF'></td>";
echo "</tr>";

echo "<tr>";
echo "<td width='94' align='right'><font size='2' color='#0000FF'>ไฟล์แนบ 2&nbsp;</font></td>";
echo "<td width='274' align='left'>&nbsp;<input type='file' name='myfile2' class='textinput' size='26' style='background-color: #FFDDFF'> </td>";
echo "<td width='238' align='center' colspan='2'><input type='text' class='textinput' name='dfile2' size='31' style='background-color: #BBD1FF'></td>";
echo "</tr>";

echo "<tr>";
echo "<td width='94' align='right'><font size='2' color='#0000FF'>ไฟล์แนบ 3&nbsp;</font></td>";
echo "<td width='274' align='left'>&nbsp;<input type='file' name='myfile3' class='textinput' size='26' style='background-color: #FFDDFF'> </td>";
echo "<td width='238' align='center' colspan='2'><input type='text'class='textinput' name='dfile3' size='31' style='background-color: #BBD1FF'></td>";
echo "</tr>";

echo "<tr>";
echo "<td width='94' align='right'><font size='2' color='#0000FF'>ไฟล์แนบ 4&nbsp;</font></td>";
echo "<td width='274' align='left'>&nbsp;<input type='file' name='myfile4' class='textinput' size='26' style='background-color: #FFDDFF'> </td>";
echo "<td width='238' align='center' colspan='2'><input type='text'class='textinput' name='dfile4' size='31' style='background-color: #BBD1FF'></td>";
echo "</tr>";

echo "<tr>";
echo "<td width='94' align='right'><font size='2' color='#0000FF'>ไฟล์แนบ 5&nbsp;</font></td>";
echo "<td width='274' align='left'>&nbsp;<input type='file' name='myfile5'class='textinput' size='26' style='background-color: #FFDDFF'> </td>";
echo "<td width='238' align='center' colspan='2'><input type='text' class='textinput' name='dfile5' size='31' style='background-color: #BBD1FF'></td>";
echo "</tr>";
...
//ตรวจสอบสถานะสารบรรสำนัก
	$sql_p2="select * from bookregister_permission where person_id=$person_id and saraban_status='2'";
	$dbquery_p2 = mysqli_query($connect,$sql_p2);
	$ref_result_p2 = mysqli_fetch_array($dbquery_p2);
	$total_p2 = mysqli_num_rows($dbquery_p2);
//echo 	$total_p2;
//ตรวจสอบสถานะสารบรรกลุ่ม
	$sql_p3="select * from bookregister_permission where person_id=$person_id and saraban_status='3'";
	$dbquery_p3 = mysqli_query($connect,$sql_p3);
	$ref_result_p3 = mysqli_fetch_array($dbquery_p3);
	$total_p3 = mysqli_num_rows($dbquery_p3);
//echo 	$total_p3;
...
if($_REQUEST['search_index']==1){
		...
		$sql="select * from bookregister_send where department='$department_id' and $_REQUEST[field] like '%$_REQUEST[search]%'  ";
		}
}
else{
$sql="select * from bookregister_send where  department='$department_id' "; 
}
$dbquery = mysqli_query($connect,$sql);
...
echo "<INPUT TYPE='button' name='smb' value='ลงทะเบียนหนังสือ' class='btnew' onclick='location.href=\"?option=bookregister&task=main/send_de&index=1\"'>";
echo "</td>";
...
<td align="right">
				...
				</font><select size="1" name="field" class="textinput">
				<?php
				...
				echo "<input type='text' name='search' class='textinput' size='20' value='$_REQUEST[search]'>"; 
				echo "<input type='hidden' name='search_index' value='1'>";
				echo " <input type='submit' class='btnew' value='ค้นหา'>";
echo "</td>";		
		
/////////////////////
echo "<td align='right'>";
	echo "<Select  class='textinput' name='sub_department' size='1'>";
	...
	echo "</select>";
	echo " <input type='submit' class='btnew' value='เลือก'>";
echo "</td>";					
/////////////////				
...
<table border="1" width="99%" id="table2" style="border-collapse: collapse" align="center">
				<tr bgcolor="#99FFFF">
					...
					<font size="2" face="Tahoma">ลำดับ</font></td>
					<td align="center" width="50">
...
if($_REQUEST['search_index']==1){
		if($_REQUEST['department']!=""){
		$sql="select * from bookregister_send where $_REQUEST[field] like '%$_REQUEST[search]%' and department='$department_id'  order by year desc, register_number_de DESC limit $start,$pagelen "; 
		}
		else{
		$sql="select * from bookregister_send where $_REQUEST[field] like '%$_REQUEST[search]%' and department='$department_id' order by year desc, register_number_de DESC limit $start,$pagelen "; 
		}
		...
		$sql="select * from bookregister_send where $_REQUEST[field] like '%$_REQUEST[search]%' and sub_department='$sub_department' order by year desc, register_number_g DESC  limit $start,$pagelen "; 
		}
		else{
		$sql="select * from bookregister_send where $_REQUEST[field] like '%$_REQUEST[search]%'  and sub_department='$sub_department_id' order by year desc, register_number_g  DESC limit $start,$pagelen "; 
		}
...
$sql="select * from bookregister_send where  department='$department_id' order by year desc, register_number_de DESC limit $start,$pagelen "; 
...
$timestamp_recdate_2=$timestamp_recdate+864000;  //เพิ่มเวลา 24 ชั่วโมง
...
if(($result['officer']==$user or $total_p2==1) and ($delete==1)){	
...
if(($check_book_num==0) and ($total_p2=='1' or $result['officer']==$_SESSION['login_user_id'])){
...
echo "<tr><td colspan='3'>&nbsp;&nbsp;<FONT COLOR='#009933'><IMG SRC='modules/bookregister/images/file1.gif' WIDTH='16' HEIGHT='16' BORDER='0'>มีไฟล์เอกสาร</FONT></td>";
echo "";
?><form id='form1' name='form1' method='post' action='modules/bookregister/main/export_send_all_day.php?department=<?php echo $department_id ?>' target='_blank'><td colspan='2'>เลือกวันที่ </td><td colspan='10'><input type='submit' name='button' id='button' value='ส่งออก Excel' /><script>DateInput('date_value', true, 'YYYY-MM-DD')</script><script>DateInput('date_value2', true, 'YYYY-MM-DD')</script></td></form>
<?php
echo "</tr>";
echo "</table>";
}  //end index
