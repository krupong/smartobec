...
$sql="select * from bookregister_receive where  sub_department='$sub_department_id' order by year,register_number limit $start,$pagelen "; 
}
$dbquery = mysqli_query($connect,$sql);
...
if($register_number_g==0){
	$register_number_g="<font color='#FF0000'>ยังไม่ลงรับหนังสือ</font>";
}
else{
	$register_number_g=$register_number_g;
}
