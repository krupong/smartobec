...
$sql="select * from bookregister_receive where year='$result_start[year]' and record_type='1' and department='$department_id' order by ms_id ";
}
if ($department_id == '' and $sub_department_id > ''){  //สารบรรณกลุ่ม
$sql="select * from bookregister_receive where year='$result_start[year]' and record_type='1' and sub_department='$sub_department_id' order by ms_id ";
}
