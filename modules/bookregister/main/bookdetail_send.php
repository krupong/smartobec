...
$sql = mysqli_query($connect,"SELECT * FROM  bookregister_send WHERE  ms_id='$_REQUEST[id]' ") ;
...
$result_person= mysqli_fetch_array($sql_person) ;
	...
	<table border="0" width="480" id="table1" style="border-collapse: collapse; border: 1px dotted #FF00FF; ; padding-left:4px; padding-right:4px; padding-top:1px; padding-bottom:1px" cellpadding="2" >
		...
		<tr>
			...
			<font size="2" color="#993366">&nbsp;เลขทะเบียนส่ง สพฐ. : </font> <FONT SIZE="2" COLOR="#9900CC"><?php echo $register_number;?></font></td>
		</tr>
		<tr>
			<td width="449" align="left" colspan="2" style="border: 1px dotted #808000">
			<font size="2" color="#993366">&nbsp;เลขทะเบียนส่ง สำนัก : </font> <FONT SIZE="2" COLOR="#9900CC"><?php echo $register_number_de;?></font></td>
		</tr>
		<tr>
			<td width="449" align="left" colspan="2" style="border: 1px dotted #808000">
			<font size="2" color="#993366">&nbsp;เลขทะเบียนส่ง กลุ่ม. : </font> <FONT SIZE="2" COLOR="#9900CC"><?php echo $register_number_g;?></font></td>
		</tr>
		<tr>
			<td width="449" align="left" colspan="2" style="border: 1px dotted #808000">
...
if($result['secret']==1){
				...
				?>
									<tr>
										<td align="left">&nbsp;<FONT SIZE="2"><?php echo $list;?>. </FONT><A HREF="../../../upload/bookregister/upload_files2/<?php echo $file_name;?>" title="คลิกเพื่อเปิดไฟล์แนบลำดับที่ <?php echo $list;?>" target="_BLANK"><FONT SIZE="2" COLOR="#CC0099"><span style="text-decoration: none"><?php echo $file_des;?></span></FONT></A></td>
									</tr>
				<?php
				}
				else{
...
<CENTER><input border="0" src="../images/button95.jpg" name="I1" width="100" height="20" type="image" onClick="javascript:window.close()">&nbsp;&nbsp;&nbsp;<A HREF="javascript:window.print()" title="พิมพ์หน้านี้"><img border="0" src="../images/print.gif" width="25" height="25"></A></CENTER>
