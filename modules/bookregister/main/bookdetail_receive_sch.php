...
$sql = mysqli_query($connect,"SELECT * FROM  bookregister_receive_sch WHERE  ms_id='$_REQUEST[id]' ") ;
...
$sql_person=mysqli_query($connect,"SELECT * FROM  person_sch_main WHERE  person_id='$result[officer]' ") ;
...
$sql_file = mysqli_query($connect,"SELECT * FROM  bookregister_send_filebook WHERE ref_id='$ref_id' order by id") ;
$road="../../bookregister/upload_files2/";
}
else if($result['book_link']==2){
$sql_file = mysqli_query($connect,"SELECT * FROM  bookregister_receive_filebook_sch WHERE ref_id='$ref_id' order by id ") ;
$road="../../bookregister/upload_files1/";
}
