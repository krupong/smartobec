...
//เมนูทะเบียนหนังสือ สารบรรณสำนัก
	...
	if($_SESSION['admin_bookregister']=="bookregister" or $result_permission['saraban_status']==1 or $result_permission['saraban_status']==2 or $result_permission['saraban_status']==3){	 //กำหนดสิทธิ์ให้เห็นเมนู  admin และ สารบรรณกลาง สพฐ.
	?>
			<li class='dropdown'>
				<a href='?option=bookregister&task=main/command' class='dropdown-toggle' data-toggle='dropdown' role='button' aria-expanded='false'>
					...
					&nbsp;ทะเบียนคำสั่ง <span class='caret'></span>
				</a>
				<ul class='dropdown-menu' role='menu'>
					<li><a href='?option=bookregister&task=main/command'>ทะเบียนคำสั่ง สพฐ.</a></li>
					<li><a href='?option=bookregister&task=main/command_sch'>ทะเบียนคำสั่ง สำนัก</a></li>
				</ul>
				<!--</li>-->
