...
$sql_create="INSERT INTO `bookregister_office_no` VALUES (1, 'ที่ ศธ1234/')";
$query = mysqli_query($connect,$sql_create);

$sql_create="CREATE TABLE IF NOT EXISTS `bookregister_certificate_sch` (
  `ms_id` int(11) NOT NULL AUTO_INCREMENT,
...
$sql_create="CREATE TABLE IF NOT EXISTS `bookregister_command_sch` (
  `ms_id` int(11) NOT NULL AUTO_INCREMENT,
  `school_code` varchar(15) NOT NULL,
  `year` int(11) NOT NULL,
  `register_number` int(11) NOT NULL,
...
$sql_create="CREATE TABLE IF NOT EXISTS `bookregister_receive_filebook_sch` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `school_code` varchar(15) NOT NULL,
  `ref_id` varchar(50) NOT NULL,
  `file_name` varchar(100) NOT NULL,
...
$sql_create="CREATE TABLE IF NOT EXISTS `bookregister_receive_sch` (
  `ms_id` int(11) NOT NULL AUTO_INCREMENT,
  `school_code` varchar(15) NOT NULL,
  `year` int(11) NOT NULL,
  `register_number` int(11) NOT NULL,
...
$sql_create="CREATE TABLE IF NOT EXISTS `bookregister_send_filebook_sch` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ref_id` varchar(50) NOT NULL,
  `file_name` varchar(100) NOT NULL,
  `file_des` varchar(100) NOT NULL,
...
$sql_create="CREATE TABLE IF NOT EXISTS `bookregister_send_sch` (
  `ms_id` int(11) NOT NULL AUTO_INCREMENT,
  `school_code` varchar(15) NOT NULL,
  `year` int(11) NOT NULL,
  `register_number` int(11) NOT NULL,
