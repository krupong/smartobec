                      ...
                      <?php
                        switch ($row["bookstatusid"]) {
                          ...
                          case '4':
                            ...
                            break;  
                          case '20':
                            echo "<a href='?option=bookregister&task=main/send_de&index=1' class='btn btn-success' role='button'><span class='glyphicon glyphicon-envelope' aria-hidden='true'></span> ส่ง</a>";
                            break;
                          case '21':
                            echo "<a href='?option=bookregister&task=main/send_de&index=1' class='btn btn-success' role='button'><span class='glyphicon glyphicon-envelope' aria-hidden='true'></span> ส่ง</a>";
                            break;
