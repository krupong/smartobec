...
?>
  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      <p><h4 class="box-title">แฟ้มตรวจแล้ว (รายการบันทึกที่ลงความเห็นแล้ว)</h4></p>
      <div class="row">
        <div class="col-md-6 text-left">
          <a href="?option=ioffice&task=book_passed" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="รีเฟรช"><span class="glyphicon glyphicon-refresh"></span></a>
        </div>
        <div class="col-md-6 text-right">
          <form class="form-inline" action="#" enctype="multipart/form-data" method="POST" >
            ...
            <button type="submit" class="btn btn-default"><span class="glyphicon glyphicon-search" data-toggle="tooltip" data-placement="top" title="ค้นหา"></span></button>
            <a href="?option=ioffice&task=book_manage&action=passed_clearsearchtext" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="แสดงทั้งหมด"><span class="glyphicon glyphicon-list"></span></a>
          </form>
        </div>
      </div>
    </div>
    <div class="box-body">
      ...
      $sql = "  SELECT 
                ...
                WHERE /*ioffice_book.bookstatusid <> 2 and*/ 
                      ...
                      $sql_search  
                ORDER BY postdate DESC, bookid ASC";
            ...
            <ul class="pagination">
              <?php 
                for($x=1;$x<=$page;$x++){
                  ...
                  echo "<li $active><a href='?option=ioffice&task=book_passed&page=$x'>$x <span class='sr-only'></span></a></li>"; 
                }
              ?>
            </ul>
          </nav>
