                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <input type="hidden" id="booklevelid" name="booklevelid" value="<?php echo $row['booklevelid']; ?>">
                              ...
                              <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active"><a href="#approve" aria-controls="approve" role="tab" data-toggle="tab">ลงความเห็น(Approve)</a></li>
                                <?php if($row["bookstatusid"]!=4){ ?>
                                <li role="presentation"><a href="#consult" aria-controls="consult" role="tab" data-toggle="tab">ขอความเห็น(Consult)</a></li>
                                <?php } ?>
                              </ul>
                              <!-- Tab panes -->
