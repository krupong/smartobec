...
echo "<Center>";
echo "<Font color='#006666' ><B>จองห้องประชุม</Font>";
echo "</Cener>";
echo "<Br><Br>";
...
echo "</select>";
echo "</Td></Tr>";
echo "<Tr align='left'><Td align='right'>วัตถุประสงค์&nbsp;&nbsp;</Td><Td><Input Type='Text' Name='objective' Size='30'></Td></Tr>";
echo "<Tr align='left'><Td align='right'>จำนวนผู้เข้าประชุม&nbsp;&nbsp;</Td><Td><Input Type='Text' Name='person_num' Size='4'>&nbsp;คน</Td></Tr>";
echo "<Tr align='left'><Td align='right'>อื่น ๆ (ถ้ามี)&nbsp;&nbsp;</Td><Td><Input Type='Text' Name='other' Size='20'></Td></Tr>";
echo "</Table>";
echo "<Br>";
...
echo "<INPUT TYPE='button' name='smb' value='ยืนยัน' onclick='location.href=\"?option=meeting&task=main/meeting_mobile&index=3&id=$_GET[id]&page=$_REQUEST[page]&room_index=$_REQUEST[room_index]\"'>
		&nbsp;&nbsp;<INPUT TYPE='button' name='back' value='ยกเลิก' onclick='location.href=\"?option=meeting&task=main/meeting_mobile&page=$_REQUEST[page]&room_index=$_REQUEST[room_index]\"'";
echo "</td></tr></table>";
}
...
echo "<Tr bgcolor='#FFCCCC' align='center'><Td width='80'>วันที่</Td><Td width='100'>ห้องประชุม</Td><Td  width='60'>ตั้งแต่เวลา</Td><Td width='60'>ถึงเวลา</Td><Td>วัตถุประสงค์</Td><Td width='100'>ผู้จอง</Td><Td width='40'>ลบ</Td><Td width='40'>อนุมัติ</Td></Tr>";
