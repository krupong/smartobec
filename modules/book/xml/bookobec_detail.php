...
//ลงทะเบียนรับหนังสือ
$sql_answer = mysqli_query($connect,"SELECT id FROM  book_sendto_answer WHERE ref_id ='$ref_id' and send_to='$_GET[khet]' and answer is null ") ;
$ans_num = mysqli_num_rows ($sql_answer) ;
if ($ans_num>0) {
$day_now=date("Y-m-d H:i:s");
$sql_answer = mysqli_query($connect,"update book_sendto_answer set answer='1', answer_time='$day_now' where ref_id='$ref_id' and send_to='$_GET[khet]'") ;
}
?>
	<div align="center">
