...
$sql = "select  id  from book_permission where book_permission.p4!=''";
$dbquery = mysqli_query($connect,$sql);
...
While ($result = mysqli_fetch_array($dbquery))
	{
		...
		echo "<Tr bgcolor=$color><Td align='center' width='50'>$N</Td><Td  align='left'>$p4 $khet_ar[$p4]</Td><Td  align='left'>$prename$name $surname</Td><td>$result_person[prename]$result_person[name] $result_person[surname]</td>";
		if($person_level==1){
