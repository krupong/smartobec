...
$sql = mysqli_query($connect,"SELECT * FROM  book_main WHERE  ms_id  ='$_GET[b_id]' ") ;
...
//xx
if($row2['secret']==1){
				if($_SESSION['login_user_id']==$row2['sender']){
				?>
									<tr>
...
$sql_name = "select * from book_sendto_answer where ref_id='$ref_id' and (send_level='1' or send_level='2' or send_level='3') order by abs(send_to) ";
