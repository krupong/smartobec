...
if ($level==1) {
	...
	?>
<center><h4>รายละเอียดหนังสือ</h4></center>
...
if($row2['secret']==1){
				?>
									<tr>
										<td align="left">&nbsp;<?php echo $list;?>. <span style="text-decoration: none"><?php echo $file_des;?></span></td>
									</tr>
				<?php 
}
else{
				?>
									<tr>
										<td align="left">&nbsp;<?php echo $list;?>. <A HREF="../../../upload/book/upload_files/<?php echo $road.$file_name;?>" title="คลิกเพื่อเปิดไฟล์แนบลำดับที่ <?php echo $list;?>" target="_BLANK"><span style="text-decoration: none"><?php echo $file_des;?></span></A>&nbsp;&nbsp;<span class="glyphicon glyphicon-paperclip" aria-hidden="true"></span></td>
									</tr>
				<?php 
}
//endxx			
...
echo "<tr><td align='left'>&nbsp;$M.$office_name_ar[$send_to]</td><td align='left'>";
		...
		if ($answer==0) {
		$ans_img = "<font color='#ff0000'><span class='glyphicon glyphicon-floppy-remove' aria-hidden='true'></span></font> ยังไม่ลงทะเบียนรับ" ;
echo " <form method='post' action=''>
 <button type='submit' class='btn btn-info' name='submit'><span class='glyphicon glyphicon-floppy-saved' aria-hidden='true'></span> ลงทะเบียนรับ</button>
</form>";
		} 
		else if($answer==1) {
		$ans_img = "<font color='#33cc00'><span class='glyphicon glyphicon-floppy-saved' aria-hidden='true'></span></font> ลงทะเบียนรับแล้วเมื่อ $answer_time" ;
		}
echo $ans_img; 
...
<CENTER><a href="index.php?option=book&task=main/receive_in"><div class="btn btn-default"><span class="glyphicon glyphicon-off" aria-hidden="true"></span> ปิด </a></CENTER>
</td></tr>
</table>
</td></tr></table>
</body>
