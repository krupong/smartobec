...
$department  = $_SESSION['system_user_department'];  //รหัสสำนัก
...
$day_now=date("Y-m-d H:i:s");
				...
				$sql = "update bookregister_receive set register_number_g=$register_number_g, sub_department=$sub_department where ref_id='$ref_id' and department = '$department'";
