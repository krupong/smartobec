...
echo "<div class='col-md-12' align='left'><p><INPUT TYPE='button' class='btn btn-primary' name='smb' value='ค้นหาหนังสือส่งทุกสำนัก' onclick='location.href=\"?option=book&task=main/send2\"'></p>
";
}
?>
...
?>
			<tr class='odd gradeX'>
					<td align="center"><FONT size="2" ><?php echo $M;?></font></td>
...
$delete=2;    //no
					...
					echo "<a href='?option=book&task=main/send&index=2'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a></td>";
					}
					else{
					echo "</td>";
					}
...
echo "</tbody><tr><td colspan='8'>&nbsp;&nbsp;<FONT COLOR='#009933'><IMG SRC='modules/book/images/file1.gif' WIDTH='16' HEIGHT='16' BORDER='0'><FONT size='2' >มีไฟล์เอกสาร</font></td></tr>";
echo "</table>";
