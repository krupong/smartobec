...
$a0_1="";  $a0_2=""; $a1_1=""; $a1_2="";  $a2_1="";  $a2_2="";  $a3_1="";  $a3_2="";  $a4_1="";  $a4_2="";  
		...
		if($_SESSION['login_group']==1){
				...
				if($result_permission['p1']==1){
				//echo "<b><a href=?option=book&task=main/receive&saraban_index=9><button class='btn btn-primary'>ทั้งหมด</button></a></b>";





   echo " $a0_1<a href='?option=book&task=main/receive_test&saraban_index=9' class='btn btn-primary'>ทั้งหมด</a>$a0_2";

   echo " <a href='?option=book&task=main/receive_test&saraban_index=1' class='btn btn-primary'>สพฐ.</a>";
				...
				//echo "&nbsp;$a2_1<b><a href=?option=book&task=main/receive&saraban_index=2><button class='btn btn-warning'>สำนัก</button></a></b>$a2_2";
				   echo " <a href='?option=book&task=main/receive_test&saraban_index=2' class='btn btn-primary'>สำนัก</a>";
				...
				//echo "&nbsp;$a3_1<b><a href=?option=book&task=main/receive&saraban_index=3><button  class='btn btn-danger'>กลุ่ม</button></a></b>$a3_2";
				   echo " <a href='?option=book&task=main/receive_test&saraban_index=3' class='btn btn-primary'>กลุ่ม</a>";

				}
				   echo " <a href='?option=book&task=main/receive_test&saraban_index=4' class='btn btn-primary'>บุคคล</a>";
