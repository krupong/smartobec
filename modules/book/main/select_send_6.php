...
$list=1;
echo "<FONT SIZE='3' color='#800080'><b>เลือกสำนัก </b></font><br>";
...
<br /><br />
  <form method="POST" action="select_send_6.php" name="form1" >
...
if($sd_index=='some'){
$result1=mysqli_query($connect,"SELECT * FROM  system_department  where  department='$_REQUEST[department]' and department != '$_SESSION[user_khet]' order by department") ;
}
/* 
else{
$result1=mysqli_query($connect,"SELECT * FROM  book_department_member left join system_department on book_department_member.khet_id=system_department.unit_code WHERE  book_department_member.grp_id= '$sd_index' order by system_department.khet_type, system_department.unit_code") ;
}
*/
...
?>&nbsp;<FONT SIZE="2" COLOR=""><A HREF="select_send_3.php?sendtoname=<?php echo $sendtoname?>&index=2&sd_index=<?php echo $sd_index?>"><IMG SRC="../../../images/b_drop.png" WIDTH="16" HEIGHT="16" BORDER="0" ALT="ลบออก"></A>&nbsp; <?php echo $list2?>. <?php echo $department_name?></FONT><BR>
