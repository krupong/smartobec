...
if($_SESSION['login_group']==1){
					...
					$sql="select book_main.ms_id, book_main.ref_id, book_main.book_no ,book_main.level, book_main.subject, book_main.signdate, book_main.office, book_main.send_date, book_sendto_answer.answer, book_sendto_answer.status, book_sendto_answer.forward_from, book_sendto_answer.rec_forward_date, book_sendto_answer.school, book_main.secret,book_main.bookregis_link,book_main.book_type from book_main, book_sendto_answer where book_main.ref_id=book_sendto_answer.ref_id and  book_sendto_answer.send_to='$result_permission[p2]'  order by book_main.ms_id   DESC  ";
					}
					else if($saraban_index==3){
					$sql="select book_main.ms_id, book_main.ref_id, book_main.book_no ,book_main.level, book_main.subject, book_main.signdate, book_main.office, book_main.send_date, book_sendto_answer.answer, book_sendto_answer.status, book_sendto_answer.forward_from, book_sendto_answer.rec_forward_date, book_sendto_answer.school, book_main.secret,book_main.bookregis_link,book_main.book_type from book_main, book_sendto_answer where book_main.ref_id=book_sendto_answer.ref_id and  book_sendto_answer.send_to='$result_permission[p3]'  order by book_main.ms_id DESC   ";
					}
					else if($saraban_index==4){
					$sql="select book_main.ms_id, book_main.ref_id, book_main.book_no ,book_main.level, book_main.subject, book_main.signdate, book_main.office, book_main.send_date, book_sendto_answer.answer, book_sendto_answer.status, book_sendto_answer.forward_from, book_sendto_answer.rec_forward_date, book_sendto_answer.school, book_main.secret,book_main.bookregis_link,book_main.book_type from book_main, book_sendto_answer where book_main.ref_id=book_sendto_answer.ref_id and  book_sendto_answer.send_to='$user' order by book_main.ms_id  DESC   ";
					}
					else if($saraban_index==9){
					$sql="select book_main.ms_id, book_main.ref_id, book_main.book_no ,book_main.level, book_main.subject, book_main.signdate, book_main.office, book_main.send_date, book_sendto_answer.answer, book_sendto_answer.status, book_sendto_answer.forward_from, book_sendto_answer.rec_forward_date, book_sendto_answer.school, book_main.secret,book_main.bookregis_link,book_main.book_type from book_main, book_sendto_answer where book_main.ref_id=book_sendto_answer.ref_id and  book_main.book_type='2' and book_sendto_answer.send_level='2' order by book_main.ms_id  DESC   ";
					}
}

if($_SESSION['login_group']>=2){
					if($_REQUEST['search_index']==1){
					$sql="select book_main.ms_id, book_main.ref_id, book_main.book_no, book_main.level, book_main.subject, book_main.signdate, book_main.office, book_main.send_date, book_sendto_answer.answer, book_sendto_answer.status, book_sendto_answer.forward_from, book_sendto_answer.rec_forward_date, book_sendto_answer.school, book_main.secret,book_main.bookregis_link,book_main.book_type from book_main, book_sendto_answer where book_main.ref_id=book_sendto_answer.ref_id and  book_sendto_answer.send_to='$result_permission[p4]' and book_sendto_answer.answer is null and $_REQUEST[field] like '%$_REQUEST[search]%' order by book_main.ms_id  DESC  ";
					}
				else {
				//$sql="select book_main.ms_id, book_main.ref_id, book_main.book_no, book_main.level, book_main.subject, book_main.signdate, book_main.office, book_main.send_date, book_sendto_answer.answer, book_sendto_answer.status, book_sendto_answer.forward_from, book_sendto_answer.rec_forward_date, book_sendto_answer.school, book_main.secret,book_main.bookregis_link,book_main.book_type from book_main, book_sendto_answer where book_main.ref_id=book_sendto_answer.ref_id and  book_sendto_answer.send_to='$result_permission[p4]' and book_sendto_answer.status is null order by book_main.ms_id  DESC  ";
$sql="SELECT
book_main.ms_id,
book_main.book_type,
book_main.sender,
...
book_sendto_answer.send_level,
book_sendto_answer.ref_id,
book_sendto_answer.send_to,
book_sendto_answer.school,
book_sendto_answer.`status`,
book_sendto_answer.answer,
book_sendto_answer.answer_time,
book_sendto_answer.forward_from,
book_sendto_answer.rec_forward_date
FROM
book_main
right Join book_sendto_answer ON book_main.ref_id = book_sendto_answer.ref_id
WHERE
book_main.ref_id=book_sendto_answer.ref_id and  book_sendto_answer.send_to='$result_permission[p4]' and book_sendto_answer.answer is null order by book_main.ms_id  DESC  ";
...
?>
			<tr>
					...
					<td  align="center"><A HREF="?option=book&task=main/bookdetail_other_saraban_new&b_id=<?php echo $result['ms_id'];?>"><span class='glyphicon glyphicon-list-alt' aria-hidden='true'></span></A></td>
