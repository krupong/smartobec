...
$num_select = mysqli_num_rows ($result_select) ;
	if ($num_select==0) {
         ?>
         <input type="checkbox" name="s_id[<?php echo $list1?>]" value="<?php echo $department?>"><FONT SIZE="2" COLOR="#660099"><?php echo $department_name?></FONT><br>
...
?>&nbsp;<FONT SIZE="2" COLOR=""><A HREF="select_send_5.php?sendtoname=<?php echo $send_to;?>&index=2&sd_index=<?php echo $sd_index?>"><IMG SRC="../../../images/b_drop.png" WIDTH="16" HEIGHT="16" BORDER="0" ALT="ลบออก"></A>&nbsp; <?php echo $list2?>. <?php echo $office_name_ar[$send_to]?></FONT><BR>
