...
if( ($_SESSION['login_group']==2) or ($_SESSION['login_status']>10) and ($_SESSION['login_status']<=15)){
		if($_REQUEST['search_index']==1){
		$saraban_index=19;		
...
if(($_SESSION['login_group']==2)or ($_SESSION['login_status']>10) and ($_SESSION['login_status']<=15)){
				...
				$sql="select book_main.ms_id, book_main.ref_id, book_main.book_no, book_main.level, book_main.subject, book_main.signdate, book_main.office, book_main.send_date, book_sendto_answer.answer, book_sendto_answer.status, book_sendto_answer.forward_from, book_sendto_answer.rec_forward_date, book_sendto_answer.school, book_main.secret,book_main.bookregis_link,book_main.book_type from book_main, book_sendto_answer where book_main.ref_id=book_sendto_answer.ref_id and  book_sendto_answer.send_to='$result_permission[p3]' and (book_sendto_answer.status is null or book_sendto_answer.status=6) order by book_main.ms_id, book_sendto_answer.id limit $start,$pagelen";
					...
					$sql="select book_main.ms_id, book_main.ref_id, book_main.book_no, book_main.level, book_main.subject, book_main.signdate, book_main.office, book_main.send_date, book_sendto_answer.answer, book_sendto_answer.status, book_sendto_answer.forward_from, book_sendto_answer.rec_forward_date, book_sendto_answer.school, book_main.secret,book_main.bookregis_link,book_main.book_type from book_main, book_sendto_answer where book_main.ref_id=book_sendto_answer.ref_id and  book_sendto_answer.send_to='$user' and  book_sendto_answer.school='$khet_code]' order by book_main.ms_id, book_sendto_answer.id limit $start,$pagelen";
					}
					else if($saraban_index==19){
					$sql="select book_main.ms_id, book_main.ref_id, book_main.book_no, book_main.level, book_main.subject, book_main.signdate, book_main.office, book_main.send_date, book_sendto_answer.answer, book_sendto_answer.status, book_sendto_answer.forward_from, book_sendto_answer.rec_forward_date, book_sendto_answer.school, book_main.secret,book_main.bookregis_link,book_main.book_type from book_main, book_sendto_answer where book_main.ref_id=book_sendto_answer.ref_id and  book_sendto_answer.send_to='$khet_code' and book_sendto_answer.school is null order by book_main.ms_id, book_sendto_answer.id limit $start,$pagelen";
					}
...
$office_name_ar[$row_sch['hket_code']]=$row_sch['khet_name'];
}
