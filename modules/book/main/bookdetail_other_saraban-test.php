...
if ($level==1) {
	...
	<div align="center">
	<table border="0" width="700" id="table1" style="border-collapse: collapse; border: 1px dotted #FF00FF; ; padding-left:4px; padding-right:4px; padding-top:1px; padding-bottom:1px" cellpadding="2" >
		<tr>
...
<input type="hidden" name="answer_time"  value="<?=$day_now;?>">

   
   <input  type="submit"   name="send" id="inputid" value="ลงทะเบียนรับ">
   </form>
...
<CENTER><a href="index.php?option=book&task=main/receive_in1">X</a></CENTER>
</td></tr>
</table>
