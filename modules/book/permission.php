...
echo "<tr><td align='center' colspan='2'><INPUT TYPE='button' name='smb' class='btn btn-primary' value='ตกลง' onclick='goto_url(1)'>
	&nbsp;&nbsp;&nbsp;";
echo "<INPUT TYPE='button' class='btn btn-danger' name='back' value='ย้อนกลับ' onclick='goto_url(0)'></td></tr>";
echo "</Table>";
echo "</td></tr></table>";
...
echo "<INPUT TYPE='button' class='btn btn-danger' name='back' value='ย้อนกลับ' onclick='goto_url_update(0)'></td></tr>";
echo "</Table>";
echo "</td></tr></table>";
...
$dbquery = mysqli_query($connect,$sql);
$total = mysqli_num_rows($dbquery);  //จำนวนสารบรรณ
...
echo "<br><div class='col-md-12' align='left'><p><INPUT TYPE='button' class='btn btn-primary' name='smb' value='เพิ่มเจ้าหน้าที่' onclick='location.href=\"?option=book&task=permission&index=1\"'></p></div>";
echo "<div class='panel-body'>";
echo "<table class='table table-striped table-bordered table-hover' id='dataTables-example'>";

echo " <thead><Tr ><th  align='center'>ที่</th><th  align='center'>ชื่อเจ้าหน้าที่</th><th  align='center'>สารบรรณกลางสพฐ.</th></th><th  align='center'>สารบรรณสำนัก</th><th  align='center'>สารบรรณกลุ่ม</th><th align='center' >ลบ</th><th align='center' >แก้ไข</th></Tr> </thead><tbody>";
$M=1;
While ($result = mysqli_fetch_array($dbquery))
	{
		$id = $result['id'];
		...
		echo "<tr class='odd gradeX'><Td align='center' >$M</Td><Td  align='left' >$prename$name $surname</Td><Td align='center' >$p1_pic</Td><td>";
...
echo "</td><Td align='center'  ><a href=?option=book&task=permission&index=2&id=$id><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a></Td>
		<Td align='center' ><a href=?option=book&task=permission&index=5&id=$id><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></a></Td>
	</Tr>";
