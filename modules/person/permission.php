...
echo   "<tr><td align='right'>การปฏิบัติราชการ&nbsp;&nbsp;</td>";
...
echo "<tr bgcolor='#CC9900'><Td align='center' width='110'>เจ้าหน้าที่บุคลากร</Td><Td align='center' width='110'>การปฏิบัติราชการ</Td></tr>";
$M=1;
While ($result = mysqli_fetch_array($dbquery))
	{
		$id = $result['id'];
