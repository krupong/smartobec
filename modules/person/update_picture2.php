...
if($index==1) {
$sql = "select * from person_sch_main where status='0'";
...
While ($result = mysqli_fetch_array($dbquery)){
		...
		if($pic==""){
			...
			$sql2 = "update person_sch_main set pic='$str_imgfullpath' where id='$id'";
...
echo "<INPUT TYPE='button' name='smb' value='ยืนยัน' onclick='location.href=\"?option=person&task=	update_picture2&index=1\"'>
