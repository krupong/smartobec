...
//ส่วนฟอร์มรับข้อมูล
if($postindex==1){
echo "<form id='frm1' name='frm1' action='?option=work&task=permission' method='POST' onSubmit='JavaScript:return goto_url(1);'>";
echo "<Center>";
...
echo "<tr><td align='center' colspan='2'><INPUT TYPE='submit' name='smb' class='btn btn-primary' value='ตกลง' >
	&nbsp;&nbsp;&nbsp;";
echo "<INPUT TYPE='button' name='back' class='btn btn-default' value='ย้อนกลับ' onclick='location.href=\"?option=work&task=permission\"' ></td></tr>";
echo "</Table>";
echo "</form>";
}
...
echo "&nbsp;&nbsp;<INPUT TYPE='button' name='back' value='ยกเลิก' class='btn btn-default' onclick='location.href=\"?option=work&task=permission\"'";
...
echo "<form id='frm1' name='frm1' action='?option=work&task=permission' method='POST' onSubmit='JavaScript:return goto_url_update(1);'>";
echo "<Center>";
...
echo "<tr><td align='center' colspan='2'><INPUT TYPE='submit' name='smb' class='btn btn-primary' value='ตกลง'>&nbsp;&nbsp;&nbsp;&nbsp;";
echo "<INPUT TYPE='button' name='back' value='ย้อนกลับ' class='btn btn-default' onclick='location.href=\"?option=work&task=permission\"'></td></tr>";
echo "</Table>";
echo "<Br>";
...
$color="";
        ...
        echo "<Td align='center' width='50' ><a href='?option=work&task=permission&index=3&aid=$id' class='btn btn-danger' data-toggle='confirmation'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a></Td>";
        echo "<Td align='center' width='50'><a href=?option=work&task=permission&index=5&id=$id><img src=images/edit.png border='0' alt='แก้ไข'></a></Td>
	</Tr>";
$M++;
	}
echo "</Table></form>";
