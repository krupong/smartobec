	...
	if(($permission==1)){
		...
		<li class='dropdown'><a href='?option=work' class='dropdown-toggle' data-toggle='dropdown' role='button' aria-expanded='false'><span class='glyphicon glyphicon-file' aria-hidden='true'></span>&nbsp;บันทึกข้อมูล <span class='caret'></span></a>
			<ul class='dropdown-menu' role='menu'>
                ...
                <li>
					<a href='?option=work&task=sortable_person'>
						<span class='glyphicon glyphicon-menu-right' aria-hidden='true'></span>&nbsp; เรียงลำดับรายชื่อบุคลากรในสำนัก
					</a>
				</li>
				<?php
	...
	if(isset($login_user_id)){ ?>
			<li class='dropdown'>
				...
				<ul class='dropdown-menu' role='menu'>
					...
					<li>
						<a href='?option=work&task=report_date'>
							<span class='glyphicon glyphicon-menu-right' aria-hidden='true'></span>&nbsp; สรุปการปฏิบัติราชการตามช่วงเวลา
						</a>
					</li>					<li>
