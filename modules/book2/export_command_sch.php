...
header('Content-Disposition: attachment; filename="command.xls"');# ชื่อไฟล์ 
?>
...
<?php
$sql="select * from bookregister_command_sch where year='$_GET[year_index]' and school_code='$_GET[school]' order by year,register_number"; 
