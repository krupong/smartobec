...
<div class="col-md-6">
        ...
        while ($data = mysql_fetch_row($gen->getResult())) {?>
                <tr>
                    ...
                    <td><?=$data[1]?></td>
                    <td>
                        <a href="?option=book2&task=department/show.Department&id=<?php echo $data[0];?> " class="btn btn-success btn-xs" title="แสดงข้อมูล"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"/></a>
                        <a href="?option=book2&task=department/edit.Department&id=<?php echo $data[0]; ?>" class="btn btn-primary btn-xs" title="แก้ไขข้อมูล"><span class="glyphicon glyphicon-pencil" aria-hidden="true"/></a>
