 ...
 */
     ?>
               <h3>กดเมนูตรงนี้ไปก่อนนะครับ</h3>                            
                        <div class="form-group ">
                         <div class="col-sm-6">

                             <a href="?option=book2&task=main/roleperson">หน้าเลือกบทบาท</a><br>
                             <a href="?option=book2&task=main/receive_newbook">หน้าทะเบียนหนังสือรับ</a><br>
                             <a href="?option=book2&task=main/receive_newbook_wait">หน้าทะเบียนหนังสือรับแล้วรอส่งต่อ</a><br>
                             <a href="?option=book2&task=main/receive_paper">หน้าลงทะเบียนหนังสือรับด้วยกระดาษ</a><br>
                             <a href="?option=book2&task=main/send_addbook2">หน้าส่งหนังสือราชการ</a><br>
                         </div>
                        </div>
