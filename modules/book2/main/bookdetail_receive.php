...
$result_person= mysqli_fetch_array($sql_person) ;
	...
	<table border="0" width="480" id="table1" style="border-collapse: collapse; border: 1px dotted #FF00FF; ; padding-left:4px; padding-right:4px; padding-top:1px; padding-bottom:1px" cellpadding="2" >
		...
		<tr>
			...
			<font size="2" color="#993366">&nbsp;เลขทะเบียนรับ : </font> <FONT SIZE="2" COLOR="#9900CC"><?php echo $register_number;?></font></td>
		</tr>
		<tr>
		<tr>
			<td width="449" align="left" colspan="2" style="border: 1px dotted #808000">
		...
		<tr>
			<td width="449" align="left" colspan="2" style="border: 1px dotted #808000">
			<font size="2" color="#993366">&nbsp;การปฏิบัติ : </font> <FONT SIZE="2" COLOR="#9900CC"><?php echo $operation;?></font></td>
		</tr>
		<tr>
			<td width="449" align="left" colspan="2" style="border: 1px dotted #808000">
...
<?php
if($result['book_link']==5){
echo "<iframe src='http://smart.obec.go.th/modules/book/xml/receive_file.php?ref_id=$result[ref_id]' height='100' width='350'></iframe>";
}
else{
?>			
<div align="center">
...
if($result['secret']==1){
?>
<tr><td align="left">&nbsp;<FONT SIZE="2"><?php echo $list;?>. </FONT><FONT SIZE="2" COLOR="#CC0099"><span style="text-decoration: none"><?php echo $file_des;?></span></FONT></td></tr>
<?php 
}
else{
?>
...
?>
<tr><td>&nbsp;<FONT SIZE="2" COLOR="#FF0099"> ไม่มีไฟล์แนบ</FONT></td></tr>
<?php
}
?>
</table>
