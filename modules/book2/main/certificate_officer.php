...
$dbquery_officer = mysqli_query($connect,$sql_officer);
$result_officer = mysqli_fetch_array($dbquery_officer);
if(!$result_officer){
echo "<br>";
...
$print="พิมพ์ได้เฉพาะเจ้าหน้าที่สพท.";
}
else if($result_ref ['khet_print']==2){
$print="พิมพ์ได้ทั้งเจ้าหน้าที่สพท.และสถานศึกษา";
}
...
echo "<tr><td colspan='14'><b>การพิมพ์</b> 0=ไม่พิมพ์ 1=พิมพ์โดยเจ้าหน้าที่ สพท. 2=พิมพ์ได้ทั้งเจ้าหน้าที่ สพท. และครูและบุคลากรในสถานศึกษา</td></tr>";	
echo "</table>";
echo "</form>";
}  //end index
