...
else if($result_ref ['khet_print']==2){
$print_check_2="checked";
}

echo "<tr>";
echo "<td align='right'><span lang='th'><font size='2' color='#0000FF'>การพิมพ์โดยระบบ&nbsp;</font></span></td>";
echo "<td colspan='3' align='left'>&nbsp;<input type='radio' name='khet_print' id='khet_print'  value='0' $print_check_0>ไม่พิมพ์&nbsp;<input type='radio' name='khet_print'  id='khet_print'  value='1' $print_check_1>พิมพ์ได้เฉพาะเจ้าหน้าที่ สพท.&nbsp;<input type='radio' name='khet_print'  id='khet_print'  value='2' $print_check_2>พิมพ์ได้ทั้งเจ้าหน้าที่ สพท. และสถานศึกษา</td>";
echo "</tr>";
...
<td align="right">
				...
				echo "<option value='book_no'>เลขทะเบียน</option>";
				}
				echo "</select>";
...
$dbquery_sign = mysqli_query($connect,$sql_sign );
While ($result_sign = mysqli_fetch_array($dbquery_sign))
   {
...
echo "<tr><td colspan='16'><b>การพิมพ์</b> 0=ไม่พิมพ์ 1=พิมพ์โดยเจ้าหน้าที่ สพท. 2=พิมพ์ได้ทั้งเจ้าหน้าที่ สพท. และครูและบุคลากรในสถานศึกษา</td></tr>";	
echo "</table>";
