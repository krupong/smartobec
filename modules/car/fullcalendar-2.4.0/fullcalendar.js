...
var View = fc.View = Class.extend({
	...
	updateTitle: function() {
        ...
        var temp_title1 = mytitle.slice(-4);
        var temp_title2 = parseInt(mytitle.slice(-4))+543;
        
        this.title = mytitle.replace(temp_title1,temp_title2);
        this.title = this.title.replace(temp_title1-1,temp_title2-1);
