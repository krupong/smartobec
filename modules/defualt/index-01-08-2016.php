        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            <div class="box-header">
              ...
              <h3 class="box-title">ประชาสัมพันธ์ | ติดต่อประสานงาน</h3>
          ...
          <div class="box box-danger">
                <div class="box-header with-border">
                  ...
                  <div class="box-tools pull-right">
                    <span class="label label-danger">20 Members</span>
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                    ...
                    $sqluser = "SELECT
                                ...
                                person_khet_main.surname AS surname_khet,
                                pm.position_code,
                                (SELECT MAX(ll2.logindate) FROM login_logs ll2 WHERE ll2.personid=ll1.personid) AS logindate
                                FROM
                                login_logs AS ll1
                                ...
                                pm.`name`,
                                pm.surname,
                                person_khet_main.prename,
                                person_khet_main.`name`,
                                person_khet_main.surname,
                                pm.position_code,
                                pm.department
                                ORDER BY
                                COALESCE(pm.position_code, 9999) ASC
                                LIMIT 20";
