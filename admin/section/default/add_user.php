...
////////////////////
echo "<form id='frm1' name='frm1'>";
echo "<table width='75%' align='center'><tr><Td align='left'><INPUT TYPE='button' name='smb' value='เพิ่มผู้ใช้ (User)' onclick='location.href=\"?file=add_user&index=1\"'</Td><td align='right'>";
