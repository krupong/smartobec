...
$sql = "select system_user.id, person_main.name, person_main.surname, person_main.person_id, system_user.username, system_user.userpass from system_user left join person_main on system_user.person_id=person_main.person_id where system_user.school_user = '0'  and (person_main.name like '%$_REQUEST[name_search]%' or system_user.username like '%$_REQUEST[name_search]%') ";
}
else{
...
$sql = "select system_user.id, person_main.name, person_main.surname, person_main.person_id, system_user.username, system_user.userpass from system_user left join person_main on system_user.person_id=person_main.person_id where system_user.school_user = '0' order by person_main.name limit $start,$pagelen";
}
$dbquery = mysqli_query($connect,$sql);
