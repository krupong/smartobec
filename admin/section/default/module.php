...
if($_POST['web_link']==0){	
$sql = "insert into system_module (id, module, module_desc, workgroup, module_active, where_work) values ('$row_number', '$_POST[module]', '$_POST[module_desc]','$_POST[workgroup]','1', '$_POST[where_work]')";
}
else if($_POST['web_link']==1){
$sql = "insert into system_module (id, module, module_desc, workgroup, module_active, web_link, url, where_work) values ('$row_number', '$_POST[module]', '$_POST[module_desc]','$_POST[workgroup]','1','$_POST[web_link]','$_POST[url]', '$_POST[where_work]')";
}
$dbquery = mysqli_query($connect,$sql);
...
if ($index==6){
$rec_date = date("Y-m-d");
$sql = "update system_module set  module_desc='$_POST[module_desc]', workgroup='$_POST[workgroup]', module_active='$_POST[module_active]', web_link='$_POST[web_link]', url='$_POST[url]', where_work='$_POST[where_work]' where id='$_POST[id]'";
$dbquery = mysqli_query($connect,$sql);
}
if ($index==6.5){
...
$sql = "select system_module.id,system_module.module,system_module.module_desc,system_module.web_link,system_module.module_active,system_menugroup.menugroup_desc, system_module.where_work from system_module left join system_menugroup on system_module.workgroup=system_menugroup.menugroup order by system_module.module_order limit $start,$pagelen";
$dbquery = mysqli_query($connect,$sql);
...
echo "<Tr bgcolor='#FFCCCC'><Td  align='center' width='50'>ที่</Td><Td  align='center' width='170'>ชื่อระบบงานย่อย(อังกฤษ)</Td><Td  align='center'>ชื่อระบบงานย่อย(ไทย)</Td><Td  align='center'>ประเภท</Td><Td  align='center'>กลุ่ม</Td><Td align='center'  width='50'>ลำดับ</Td><Td align='center' width='60'>สถานะใช้งาน</Td><Td align='center' width='200'>การใช้งาน</Td><Td align='center'  width='50'>ลบ</Td><Td align='center' width='50'>แก้ไข</Td></Tr>";
